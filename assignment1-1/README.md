...
<p>Submit your assignment on Autolab (https://autograder.cse.buffalo.edu/). Sign in with your MyUB, select CSE486/586 Distributed Systems (f23), assignment1-1, enter the commit tag, e.g., a11-handin, check the academic integrity box, and submit.</p>
